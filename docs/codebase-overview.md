...
| Photo wall       | `portfolio/hobby-belts.tsx`, `hobby-lightbox.tsx`                                 | Spiral intro → conveyor belts, with a static grid fallback. See [hobbies-photo-wall.md](./hobbies-photo-wall.md).                         |
